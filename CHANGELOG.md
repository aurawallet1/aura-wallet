...
### Fixed
- The transaction signer now accepts Taproot (P2TR / bech32m) destinations, matching the send screen — sending to a `bc1p…` address no longer fails after the confirmation screen.
